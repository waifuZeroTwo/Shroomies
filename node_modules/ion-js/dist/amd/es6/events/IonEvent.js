...
define(["require", "exports", "jsbi", "../ComparisonResult", "../ComparisonResult", "../IonBinaryWriter", "../IonLocalSymbolTable", "../IonTextWriter", "../IonTypes", "../IonUnicode", "../IonWriteable"], function (require, exports, jsbi_1, ComparisonResult_1, ComparisonResult_2, IonBinaryWriter_1, IonLocalSymbolTable_1, IonTextWriter_1, IonTypes_1, IonUnicode_1, IonWriteable_1) {
    "use strict";
    ...
    class AbstractIonEvent {
        ...
        compare(expected) {
            ...
            if (this.ionType !== expected.ionType) {
                return new ComparisonResult_1.ComparisonResult(ComparisonResult_2.ComparisonResultType.NOT_EQUAL, "Ion types don't match " + ((_a = this.ionType) === null || _a === void 0 ? void 0 : _a.name) +
                    " vs. " + ((_b = expected.ionType) === null || _b === void 0 ? void 0 : _b.name));
            }
            if (this.fieldName !== expected.fieldName) {
                return new ComparisonResult_1.ComparisonResult(ComparisonResult_2.ComparisonResultType.NOT_EQUAL, "Field names don't match " +
                    this.fieldName +
                    " vs. " +
                    expected.fieldName);
            }
        ...
        annotationCompare(expectedAnnotations) {
            ...
            if (this.annotations.length !== expectedAnnotations.length) {
                return new ComparisonResult_1.ComparisonResult(ComparisonResult_2.ComparisonResultType.NOT_EQUAL, "annotations length don't match" +
            ...
            for (let i = 0; i < this.annotations.length; i++) {
                if (this.annotations[i] !== expectedAnnotations[i]) {
                    return new ComparisonResult_1.ComparisonResult(ComparisonResult_2.ComparisonResultType.NOT_EQUAL, "annotation value doesn't match" +
                        this.annotations[i] +
                        " vs. " +
    ...
    class IonIntEvent extends AbstractIonEvent {
        ...
        valueCompare(expected) {
            if (expected instanceof IonIntEvent) {
                let actualValue = this.ionValue instanceof jsbi_1.default
                    ? this.ionValue
                    : jsbi_1.default.BigInt(this.ionValue);
                let expectedValue = expected.ionValue instanceof jsbi_1.default
                    ? expected.ionValue
                    : jsbi_1.default.BigInt(expected.ionValue);
    ...
    class IonStructEvent extends AbsIonContainerEvent {
        ...
        structsCompare(actualEvents, expectedEvents) {
            let matchFound = new ComparisonResult_1.ComparisonResult(ComparisonResult_2.ComparisonResultType.EQUAL);
            ...
            for (let i = 0; matchFound && i < actualEvents.length; i++) {
                ...
                for (let j = 0; matchFound.result == ComparisonResult_2.ComparisonResultType.NOT_EQUAL &&
            ...
            for (let i = 0; i < paired.length; i++) {
                if (!paired[i]) {
                    matchFound = new ComparisonResult_1.ComparisonResult(ComparisonResult_2.ComparisonResultType.NOT_EQUAL, "Didn't find matching field for " + expectedEvents[i].fieldName);
                    break;
                }
            }
            return matchFound;
        ...
        valueCompare(expected) {
            ...
            for (let i = 0; i < container.length; i++) {
                ...
                if (child.compare(expectedContainer[i]).result ==
                    ComparisonResult_2.ComparisonResultType.NOT_EQUAL) {
