...
export type QLDBSessionClientConfigType = Partial<
...
export type QLDBSessionClientResolvedConfigType =
  __SmithyResolvedConfiguration<__HttpHandlerOptions> &
    ...
    UserAgentResolvedConfig &
    ClientResolvedEndpointParameters;
export interface QLDBSessionClientResolvedConfig
  extends QLDBSessionClientResolvedConfigType {}
export declare class QLDBSessionClient extends __Client<
...
> {
  ...
  constructor(
    ...[configuration]: __CheckOptionalClientConfig<QLDBSessionClientConfig>
  );
  destroy(): void;
}
