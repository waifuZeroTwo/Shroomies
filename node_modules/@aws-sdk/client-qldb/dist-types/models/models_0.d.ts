 ...
 * @internal
 */
export declare const GetBlockRequestFilterSensitiveLog: (obj: GetBlockRequest) => any;
/**
 * @internal
 */
export declare const GetBlockResponseFilterSensitiveLog: (obj: GetBlockResponse) => any;
/**
 * @internal
 */
export declare const GetDigestResponseFilterSensitiveLog: (obj: GetDigestResponse) => any;
/**
 * @internal
 */
