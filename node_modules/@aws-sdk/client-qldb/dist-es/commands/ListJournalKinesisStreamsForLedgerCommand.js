...
import { de_ListJournalKinesisStreamsForLedgerCommand, se_ListJournalKinesisStreamsForLedgerCommand, } from "../protocols/Aws_restJson1";
export { $Command };
export class ListJournalKinesisStreamsForLedgerCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListJournalKinesisStreamsForLedgerCommand.getEndpointParameterInstructions()));
