...
import { de_ListJournalS3ExportsForLedgerCommand, se_ListJournalS3ExportsForLedgerCommand, } from "../protocols/Aws_restJson1";
export { $Command };
export class ListJournalS3ExportsForLedgerCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListJournalS3ExportsForLedgerCommand.getEndpointParameterInstructions()));
