...
import { de_UpdateLedgerPermissionsModeCommand, se_UpdateLedgerPermissionsModeCommand, } from "../protocols/Aws_restJson1";
export { $Command };
export class UpdateLedgerPermissionsModeCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateLedgerPermissionsModeCommand.getEndpointParameterInstructions()));
